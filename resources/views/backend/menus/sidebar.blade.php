<style>
        ...
        .main-sidebar {
            background:rgba(rgba(61, 70, 77, 1)) !important; /* o prueba con #f4f6f9 */
            border-right: 1px solid #e3e6ec; /* Opcional, para darle separación */
        }
        .brand-link img {
          ...
          /*   box-shadow: 0 1px 6px #0002;  Sombra suave opcional */
            ...
            .main-sidebar .nav-link, .sidebar .nav-link {
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="#" class="brand-link d-flex align-items-center justify-content-center">
        <img src="{{ asset('images/image.png') }}" 
            alt="Logo" 
            class="brand-image elevation-0 logo-full"
            style="transition: all 0.2s; max-height:32px;">
        <img src="{{ asset('images/icon.png') }}" 
            alt="Logo" 
            class="brand-image elevation-1 logo-mini"
